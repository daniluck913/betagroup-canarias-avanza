...
<header class="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
  <nav class="container mx-auto px-6 py-4">
    <div class="flex flex-wrap items-center justify-center md:justify-between gap-4">
      <!-- Logos Row -->
      <div class="w-full md:w-auto flex items-center justify-center gap-4 md:gap-6">
        <a href="index.html" class="w-1/2 md:w-auto flex justify-center">
          <img src="https://www.canariasavanza.com/wp-content/uploads/2025/09/logo-canarias-avanza.png" alt="Logo Canarias Avanza" class="h-10 md:h-12" />
        </a>
        <div class="w-1/2 md:w-auto flex justify-center">
          <img src="https://images.squarespace-cdn.com/content/v1/5f73982da413e029ee9f4c4f/1605188167499-LBZL39NLIO8EIOALSNQ1/Beta+Group+logo+final+WEB.jpg?format=1500w" alt="Beta Group Logo" class="h-8 md:h-10" />
        </div>
      </div>
      <!-- Menu Row -->
      <ul class="w-full md:w-auto flex justify-center gap-4 md:gap-6 text-sm font-medium">
...
<footer id="contacto" class="text-white py-12" style="background-color: #0080AA;">
  <div class="container mx-auto px-6">
    ...
    <div class="grid md:grid-cols-4 gap-8 mb-8">
      ...
      <!-- Columna 2: Navegación y Redes Sociales -->
      ...
      <div class="text-center">
        ...
        <p class="text-sm">C/ León y Castillo, nº 200<br>Edf. Servicios Múltiples III<br>35071 Las Palmas de Gran Canaria</p>
      </div>
...
// Function to close warning notice
function cerrarAviso() {
  const aviso = document.getElementById('aviso-prueba');
  if (aviso) {
    aviso.style.transition = 'opacity 0.3s ease-out, max-height 0.3s ease-out';
